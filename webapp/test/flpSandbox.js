		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Highlight ABAP Code",
									"targetURL": "#comsmodhighlightjshighlightcode-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodhighlightjshighlightcode-display": {
								"semanticObject": "comsmodhighlightjshighlightcode",
								"action": "display",
								"description": "A Test App To Demonstrate - Highlight.js",
								"title": "Highlight ABAP Code",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.highlightjs.highlightcode",
									"url": sap.ui.require.toUrl("com/smod/highlightjs/highlightcode")
								}
							}
						}
					}
